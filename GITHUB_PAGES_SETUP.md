...
2. **Same repo** – Your live URL is `https://www.afaithdrivenlife.com/` (or `faith_driven_life`). In Git Bash, run `git remote -v` in `c:\My Website` and confirm it points to the repo that has that URL.
